...
bindsym $mod+Mod1+space exec --no-startup-id rofi -show ssh
...
# -----------------------------------------
# KEYBINDINGS USING MODIFIER: Super/Windows
# -----------------------------------------
...
# -----------------------------------------------
# KEYBINDINGS USING MODIFIER: Super/Windows + Alt
# -----------------------------------------------

# move focused window
bindsym $mod+Mod1+odiaeresis move right
...
bindsym $mod+Mod1+1 move container to workspace $wp1
bindsym $mod+Mod1+2 move container to workspace $wp2
bindsym $mod+Mod1+3 move container to workspace $wp3
bindsym $mod+Mod1+4 move container to workspace $wp4
bindsym $mod+Mod1+5 move container to workspace $wp5
bindsym $mod+Mod1+6 move container to workspace $wp6
bindsym $mod+Mod1+7 move container to workspace $wp7
bindsym $mod+Mod1+8 move container to workspace $wp8

# reload the configuration file
bindsym $mod+Mod1+9 reload

# restart i3 inplace (preserves your layout/session, can be used to upgrade i3)
bindsym $mod+Mod1+0 restart
...
# ------------------------------------------------
# KEYBINDINGS USING MODIFIER: Super/Windows + Ctrl
# ------------------------------------------------

bindsym $mod+Ctrl+Right workspace next
bindsym $mod+Ctrl+Left workspace prev

bindsym $mod+Ctrl+e exec --no-startup-id leafpad .config/i3/config
bindsym $mod+Ctrl+c exec --no-startup-id cinnamon-control-center
bindsym $mod+Ctrl+p exec --no-startup-id xterm -e sudo synaptic
...
# bindsym Escape mode "$mode_system"
